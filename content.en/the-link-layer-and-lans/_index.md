...
R4. Suppose two nodes start to transmit at the same time a packet of length _L_ over a broadcast channel of rate _R_. Denote the propagation delay between the two nodes as _d_prop. Will there be a collision if _d_prop 6 _L_ /_R_? Why or why not?
...
R6. In CSMA/CD, after the fifth collision, what is the probability that a node chooses _K_ \= 4? The result _K_ \= 4 corresponds to a delay of how many seconds on a 10 Mbps Ethernet?
...
P9. Show that the maximum efficiency of pure ALOHA is 1/(2e). _Note_: This problem is easy if you have completed the problem above!
